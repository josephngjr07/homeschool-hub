...
// intentionally no "overdue" / red state (ADR-0001). When the Task was planned
// from an Inbox Resource with a link, a footer strip opens the source so the
// parent can launch the activity immediately (it lives outside the toggle
// button — an <a> can't nest inside a <button>).
